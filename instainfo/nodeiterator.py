...
class NodeIterator(Iterator[T]):
    ...
    of instainfo's :class:`Post`-returning functions (such as :meth:`Profile.get_posts` etc.).
...
@contextmanager
def resumable_iteration(context: instainfoContext,
                        iterator: Iterable,
                        load: Callable[[instainfoContext, str], Any],
    ...
    :param context: The :class:`instainfoContext`.
