...
from instainfo import instainfo, Post, Profile, load_structure_from_file

# instainfo instantiation - you may pass additional arguments to the constructor here
L = instainfo()

# If desired, load session previously saved with `instainfo -l USERNAME`:
