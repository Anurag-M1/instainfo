...
Contributing to instainfo
===========================

As an open source project, instainfo heavily depends on the contributions from
its community.  In this document, we advise on how you may help instainfo to
become an even greater tool.

instainfo's development is organized on 
`GitHub <https://github.com/anurag-zzibzz/InstaInfo>`__, where Issues and Pull
...
involved in instainfo development, as they do not require deep insight into
instainfo's code base, have a look at our
`Issues labelled 'good first issue' <https://github.com/anurag-zzibzz/InstaInfo>`__.

This document covers several ways of how you can contribute back to instainfo.
...
`Issue Tracker <https://github.com/anurag-zzibzz/InstaInfo>`__. When
reporting a problem, please keep the following in mind:

- Ensure you **use the latest version** of instainfo. The currently-installed
  version can be found out with ``instainfo --version``.
...
- State **how the bug can be reproduced**, i.e. how instainfo was invoked
...
Improvements of the instainfo source or its documentation can be proposed as a
`Pull Request <https://github.com/anurag-zzibzz/InstaInfo/pulls>`__.
...
- Feel free to create an issue to make sure someone from the instainfo team
...
instainfo's goal is to mimic the browser's behavior to access the data that
...
- instainfo already has plenty of features. **Check the documentation**
...
- **Motivate the feature**, i.e.
  ...
  - Briefly describe how your suggested feature **conforms with instainfo's
    project goal**.
