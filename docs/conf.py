...
# -*- coding: utf-8 -*-
#
# instainfo documentation build configuration file, created by
# 	Anurag Kumar Singh on Tuesday Mar 7 12:00:00 2023.
#
...
extlinks = {
    'issue': (
        'https://github.com/instainfo/instainfo/issues/%s',
        'Issue #'
    ),
    'example': (
        'https://raw.githubusercontent.com/instainfo/instainfo/master/docs/codesnippets/%s',
        'Example '
    ),
}
...
htmlhelp_basename = 'instainfodoc'
...
latex_documents = [
    (master_doc, 'instainfo.tex', 'instainfo Documentation',
...
man_pages = [
    (master_doc, 'instainfo', 'instainfo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'instainfo', 'instainfo Documentation',
     author, 'instainfo', 'One line description of project.',
     'Miscellaneous'),
]
...
def setup(app):
    ...
    app.add_stylesheet("instainfodoc.css")
